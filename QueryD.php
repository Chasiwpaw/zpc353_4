...
select Orders.order_number, date_placed, emp_id, Book.isbn, quantity, title, price from Orders, Orderitem,Book where cust_email = "cust1@gmail.com" and Orders.order_number = Orderitem.order_number and Orderitem.isbn=Book.isbn";
